...
export default function Cookies() {
  useEffect(() => { document.title = 'Cookie Policy - BS Channabasappa'; }, []);
  return (
    <div style={{ background: '#FDF8F3', minHeight: '100vh', padding: '60px 24px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ fontSize: '0.88rem', color: '#6B6B6B', lineHeight: 1.8 }}>
          <p>BS Channabasappa Silks & Sarees uses cookies to enhance your browsing experience, analyze site traffic, and personalize content.</p>
