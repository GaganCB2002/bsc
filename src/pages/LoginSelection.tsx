  ...
  return (
    <div className="lp-page" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <section style={{
        ...
        padding: '100px 24px',
        overflow: 'hidden',
        background: 'linear-gradient(135deg, #2C2826 0%, #2C2C2C 50%, #2C2826 100%)'
      }}>
        <div style={{
          position: 'absolute',
          inset: 0,
          ...
          <div style={{ display: 'flex', gap: '32px', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            >
              ...
              <div style={{ padding: '32px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginBottom: '10px', color: '#2C2826' }}>Customer Portal</h2>
                ...
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#A86456'}
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#C47A6A'}
                >
                  Login as Customer
                </Link>
              </div>
            ...
            >
              ...
              <div style={{ padding: '32px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginBottom: '10px', color: '#2C2826' }}>BSC Worker Portal</h2>
                <p style={{ fontSize: '0.88rem', color: '#8A7A6A', lineHeight: 1.7, marginBottom: '28px', flex: 1 }}>
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#2C2826'}
                >
                  Login as BSC Worker
                </Link>
              </div>
      ...
      <section style={{ padding: '80px 24px', backgroundColor: '#FDF8F3' }}>
        <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: 600, color: '#2C2826', marginBottom: '16px' }}>Secure, Seamless Access</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' }}>
            <div className="reveal" style={{ padding: '32px', backgroundColor: '#fff', borderRadius: '4px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', borderTop: '4px solid #C47A6A' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: 'rgba(201,168,76,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                <Shield size={24} color="#D4A574" />
              </div>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: '12px', color: '#2C2826' }}>Data Privacy</h3>
            ...
            <div className="reveal" style={{ padding: '32px', backgroundColor: '#fff', borderRadius: '4px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', borderTop: '4px solid #D4A574' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: 'rgba(201,168,76,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                <Award size={24} color="#D4A574" />
              </div>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: '12px', color: '#2C2826' }}>Premium Experience</h3>
            ...
            <div className="reveal" style={{ padding: '32px', backgroundColor: '#fff', borderRadius: '4px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', borderTop: '4px solid #2C2826' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: 'rgba(201,168,76,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                <Phone size={24} color="#D4A574" />
              </div>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: '12px', color: '#2C2826' }}>24/7 Support</h3>
