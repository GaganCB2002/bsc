    ...
    return (
      <div style={{ backgroundColor: '#FDF8F3', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ textAlign: 'center', padding: '100px 24px' }}>
          ...
          <Link to="/" style={{ color: '#C47A6A', fontSize: '0.9rem' }}>Return to home</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="container" style={{ padding: '30px 24px' }}>
        ...
        <div style={{ display: 'flex', gap: '60px', flexWrap: 'wrap' }}>
          ...
          <div className="reveal" style={{ flex: '1 1 400px', display: 'flex', flexDirection: 'column', paddingTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '2rem', fontWeight: 400, marginBottom: '16px', lineHeight: 1.2, color: '#2C2826' }}>{product.name}</h1>
            <div style={{ fontSize: '1.8rem', fontWeight: 700, color: '#C47A6A', marginBottom: '32px' }}>
            ...
            <div style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                <span style={{ fontWeight: 600, fontSize: '0.85rem', color: '#2C2826' }}>Select Size</span>
                <a href="/customer-service#size-guide" style={{ color: '#C47A6A', fontSize: '0.78rem', textDecoration: 'none' }}>Size Guide</a>
              </div>
                ...
                {['XS', 'S', 'M', 'L', 'XL', 'XXL'].map(size => (
                  <button
                    ...
                    style={{
                      width: '56px',
                      height: '56px',
                      border: `1.5px solid ${selectedSize === size ? '#C47A6A' : '#E8E0D6'}`,
                      backgroundColor: selectedSize === size ? '#F5E6D3' : '#fff',
                      color: selectedSize === size ? '#C47A6A' : '#2C2826',
                      fontWeight: 500,
                      fontSize: '0.85rem',
                      cursor: 'pointer',
                      transition: 'all 0.2s',
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  padding: '16px',
                  backgroundColor: !selectedSize ? '#B8A88A' : '#C47A6A',
                  color: '#fff',
                  border: 'none',
                  fontSize: '0.8rem',
                  fontWeight: 600,
                ...
                onMouseOver={(e) => { if (selectedSize) e.currentTarget.style.backgroundColor = '#A86456'; }}
                onMouseOut={(e) => { if (selectedSize) e.currentTarget.style.backgroundColor = '#C47A6A'; }}
              >
