...
export default function Privacy() {
  useEffect(() => { document.title = 'Privacy Policy - BSC Exclusive'; }, []);
  return (
    <div style={{ background: '#FDF8F3', minHeight: '100vh', padding: '60px 24px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 300, color: '#1A1A2E', margin: '20px 0' }}>Privacy <span style={{ fontWeight: 700, color: '#B91C1C' }}>Policy</span></h1>
        <div style={{ fontSize: '0.88rem', color: '#6B6B6B', lineHeight: 1.8 }}>
          <p>At BSC Exclusive, we take your privacy seriously. This policy describes how we collect, use, and protect your personal information.</p>
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>Information We Collect</h3>
          ...
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>How We Use Your Information</h3>
          ...
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>Data Security</h3>
          ...
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>Contact</h3>
          <p>For privacy-related inquiries, contact us at hello@bscexclusive.com.</p>
        </div>
      </div>
    </div>
  );
