  ...
  return (
    <div style={{ background: '#FDF8F3', minHeight: '100vh', padding: '60px 24px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 300, color: '#1A1A2E', margin: '20px 0' }}>Cookie <span style={{ fontWeight: 700, color: '#B91C1C' }}>Policy</span></h1>
        <div style={{ fontSize: '0.88rem', color: '#6B6B6B', lineHeight: 1.8 }}>
          ...
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>What Are Cookies</h3>
          ...
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>How We Use Cookies</h3>
          ...
          <h3 style={{ color: '#1A1A2E', margin: '24px 0 8px' }}>Managing Cookies</h3>
