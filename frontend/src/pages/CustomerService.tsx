...
export default function CustomerService() {
  ...
  return (
    <div className="lp-page" style={{ minHeight: '100vh' }}>
      ...
      <section style={{ background: '#1A1A2E', padding: '80px 24px 60px', textAlign: 'center' }}>
        <div className="container">
          <span style={{ display: 'inline-block', fontSize: '0.65rem', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#1E3A8A', border: '1px solid rgba(30,58,138,0.3)', padding: '4px 14px', marginBottom: '16px' }}>Customer Service</span>
          <h1 style={{ fontSize: '2.8rem', fontWeight: 300, color: '#fff', marginBottom: '12px' }}>We're Here to <span style={{ fontWeight: 700, color: '#1E3A8A' }}>Help</span></h1>
          ...
          {sections.map(s => (
            <a
              ...
              style={{
                ...
                color: expandedSection === s.id ? '#B91C1C' : '#8A7A6A', textDecoration: 'none', fontSize: '0.82rem', fontWeight: 500,
                borderLeft: expandedSection === s.id ? '2.5px solid #B91C1C' : '2.5px solid transparent', transition: 'all 0.2s'
              }}
              onMouseEnter={(e) => { e.currentTarget.style.color = '#B91C1C'; e.currentTarget.style.borderLeftColor = '#B91C1C'; }}
        ...
        <div style={{ flex: '1', minWidth: '0' }}>
          ...
          <section id="shipping" style={{ marginBottom: '40px', border: '1px solid #E8E0D6', background: '#fff' }}>
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 24px', cursor: 'pointer', userSelect: 'none', background: expandedSection === 'shipping' ? '#F1F5F9' : '#FDF8F3', transition: 'background 0.2s' }}
            >
              <div style={{ width: '48px', height: '48px', background: '#F1F5F9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><Truck size={22} color="#B91C1C" /></div>
              <h2 style={{ fontSize: '1.2rem', fontWeight: 500, color: '#1A1A2E', flex: 1 }}>Shipping & <span style={{ fontWeight: 600, color: '#B91C1C' }}>Delivery</span></h2>
                ...
                <div className="reveal" style={{ display: 'flex', gap: '40px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '32px' }}>
                  <div style={{ flex: '1 1 300px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                      <div style={{ background: '#F1F5F9', padding: '8px 16px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.78rem', fontWeight: 500, color: '#1A1A2E' }}><Clock size={14} color="#B91C1C" /> 3-5 Business Days</div>
                      <div style={{ background: '#F1F5F9', padding: '8px 16px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.78rem', fontWeight: 500, color: '#1A1A2E' }}><Shield size={14} color="#B91C1C" /> Free above ₹5,000</div>
                    </div>
                  </div>
                ...
                <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                  {[
                    ...
                    <div key={i} style={{ background: '#FDF8F3', border: '1px solid #E8E0D6', padding: '20px' }}>
                      <h4 style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E', marginBottom: '8px' }}>{item.title}</h4>
                      <div style={{ fontSize: '0.78rem', color: '#8A7A6A', marginBottom: '4px' }}><Clock size={12} /> {item.time}</div>
                      <div style={{ fontSize: '0.78rem', color: '#B91C1C', fontWeight: 600 }}>{item.cost}</div>
          ...
          <section id="returns" style={{ marginBottom: '40px', border: '1px solid #E8E0D6', background: '#fff' }}>
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 24px', cursor: 'pointer', userSelect: 'none', background: expandedSection === 'returns' ? '#F1F5F9' : '#FDF8F3', transition: 'background 0.2s' }}
            >
              <div style={{ width: '48px', height: '48px', background: '#F1F5F9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><RotateCcw size={22} color="#B91C1C" /></div>
              <h2 style={{ fontSize: '1.2rem', fontWeight: 500, color: '#1A1A2E', flex: 1 }}>Returns & <span style={{ fontWeight: 600, color: '#B91C1C' }}>Exchanges</span></h2>
              ...
              <div style={{ padding: '24px', borderTop: '1px solid #E8E0D6' }}>
                <div className="reveal" style={{ display: 'flex', gap: '40px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '32px' }}>
                  ...
                  <div style={{ flex: '1 1 300px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                      <div style={{ background: '#F1F5F9', padding: '8px 16px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.78rem', fontWeight: 500, color: '#1A1A2E' }}><RotateCcw size={14} color="#B91C1C" /> 30-Day Returns</div>
                      <div style={{ background: '#F1F5F9', padding: '8px 16px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.78rem', fontWeight: 500, color: '#1A1A2E' }}><Shield size={14} color="#B91C1C" /> Free Exchange</div>
                    </div>
                  </div>
                </div>
                <div className="reveal" style={{ background: '#FDF8F3', border: '1px solid #E8E0D6', padding: '32px' }}>
                  <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#1A1A2E', marginBottom: '16px' }}>Return Policy</h3>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', fontSize: '0.85rem', color: '#8A7A6A', lineHeight: 1.7 }}>
                    {[
                      ...
                      <div key={i} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                        <span style={{ color: '#B91C1C', fontWeight: 700, flexShrink: 0 }}>{String(i + 1).padStart(2, '0')}.</span>
                        <span>{item}</span>
                      </div>
                    ))}
                  </div>
          ...
          <section id="size-guide" style={{ marginBottom: '40px', border: '1px solid #E8E0D6', background: '#fff' }}>
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 24px', cursor: 'pointer', userSelect: 'none', background: expandedSection === 'size-guide' ? '#F1F5F9' : '#FDF8F3', transition: 'background 0.2s' }}
            >
              <div style={{ width: '48px', height: '48px', background: '#F1F5F9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><Ruler size={22} color="#B91C1C" /></div>
              <h2 style={{ fontSize: '1.2rem', fontWeight: 500, color: '#1A1A2E', flex: 1 }}>Size <span style={{ fontWeight: 600, color: '#B91C1C' }}>Guide</span></h2>
            ...
            <div style={{ overflow: 'hidden', maxHeight: expandedSection === 'size-guide' ? '2000px' : '0px', transition: 'max-height 0.4s ease' }}>
              <div style={{ padding: '24px', borderTop: '1px solid #E8E0D6' }}>
                ...
                <div className="reveal" style={{ overflowX: 'auto' }}>
                  <h3 style={{ fontSize: '0.88rem', fontWeight: 600, color: '#1A1A2E', marginBottom: '16px' }}>Women's Saree & Ethnic Wear</h3>
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={i} style={{ borderBottom: '1px solid #E8E0D6', background: i % 2 === 0 ? '#FDF8F3' : '#fff' }}>
                          <td style={{ padding: '10px 16px', fontWeight: 600, color: '#1A1A2E' }}>{row.size}</td>
                  ...
                  <h3 style={{ fontSize: '0.88rem', fontWeight: 600, color: '#1A1A2E', marginBottom: '16px' }}>Men's Kurta & Sherwani</h3>
          ...
          <section id="care" style={{ marginBottom: '40px', border: '1px solid #E8E0D6', background: '#fff' }}>
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 24px', cursor: 'pointer', userSelect: 'none', background: expandedSection === 'care' ? '#F1F5F9' : '#FDF8F3', transition: 'background 0.2s' }}
            >
              <div style={{ width: '48px', height: '48px', background: '#F1F5F9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><WashingMachine size={22} color="#B91C1C" /></div>
              <h2 style={{ fontSize: '1.2rem', fontWeight: 500, color: '#1A1A2E', flex: 1 }}>Care <span style={{ fontWeight: 600, color: '#B91C1C' }}>Instructions</span></h2>
                ...
                <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
                  {[
                    ...
                    <div key={i} style={{ background: '#FDF8F3', border: '1px solid #E8E0D6', padding: '24px' }}>
                      ...
                      <h4 style={{ fontSize: '0.88rem', fontWeight: 600, color: '#1A1A2E', marginBottom: '8px' }}>{item.title}</h4>
          ...
          <section id="faq" style={{ marginBottom: '40px', border: '1px solid #E8E0D6', background: '#fff' }}>
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 24px', cursor: 'pointer', userSelect: 'none', background: expandedSection === 'faq' ? '#F1F5F9' : '#FDF8F3', transition: 'background 0.2s' }}
            >
              <div style={{ width: '48px', height: '48px', background: '#F1F5F9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><HelpCircle size={22} color="#B91C1C" /></div>
              <h2 style={{ fontSize: '1.2rem', fontWeight: 500, color: '#1A1A2E', flex: 1 }}>Frequently Asked <span style={{ fontWeight: 600, color: '#B91C1C' }}>Questions</span></h2>
                ...
                <div className="reveal" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {faqData.map((item, i) => (
                    <details key={i} style={{ background: '#FDF8F3', border: '1px solid #E8E0D6', cursor: 'pointer' }}>
                      <summary style={{ padding: '18px 24px', fontSize: '0.88rem', fontWeight: 600, color: '#1A1A2E', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        {item.q}
          ...
          {/* Contact Section */}
          <section style={{ marginTop: '60px', padding: '32px', background: '#1A1A2E', color: '#fff' }}>
            ...
            <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.85rem', color: 'rgba(255,255,255,0.7)' }}>
                <Phone size={16} color="#1E3A8A" /> +91 8192 272180
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.85rem', color: 'rgba(255,255,255,0.7)' }}>
                <Mail size={16} color="#1E3A8A" /> hello@bscexclusive.com
              </div>
              <button
              ...
              >
                <MapPin size={16} color="#1E3A8A" /> Davangere — Medical College Rd
              </button>
              <button
                onClick={() => setShowStores(true)}
                style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.85rem', color: 'rgba(255,255,255,0.7)', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'inherit', padding: 0 }}
              >
                <MapPin size={16} color="#1E3A8A" /> Belgaum — Tilakwadi
              </button>
            </div>
            <button
              onClick={() => setShowStores(true)}
