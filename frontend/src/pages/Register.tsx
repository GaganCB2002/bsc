...
export default function Register() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: 'linear-gradient(135deg, #1A1A2E 0%, #1a1a1a 50%, #1A1A2E 100%)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', position: 'relative', zIndex: 1 }}>
        <div style={{ width: '100%', maxWidth: '440px' }}>
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <h1 style={{ fontSize: '2rem', fontWeight: 300, color: '#fff', marginBottom: '8px' }}>Create <span style={{ fontWeight: 700, color: '#1E3A8A' }}>Account</span></h1>
          ...
          <form onSubmit={handleSubmit} style={{ background: '#fff', padding: '36px', borderRadius: '4px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="text" value={form.name} onChange={handleChange('name')} placeholder="Your full name" style={inputStyle}
                  onFocus={(e) => e.currentTarget.style.borderColor = '#B91C1C'} onBlur={(e) => e.currentTarget.style.borderColor = '#E8E0D6'} />
              </div>
            </div>
            ...
            <button type="submit" disabled={loading}
              style={{ width: '100%', padding: '14px', background: loading ? '#B8A88A' : '#B91C1C', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em', cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '24px' }}>
              ...
              <Link to="/login" style={{ color: '#B91C1C', fontWeight: 600, fontSize: '0.85rem' }}>Sign In</Link>
            </div>
          </form>
